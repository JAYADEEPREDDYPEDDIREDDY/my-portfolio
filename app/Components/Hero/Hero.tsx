"use client"; // If using Next.js App Router, add this
...
const Hero = () => {
  ...
  <div className="flex items-center gap-4 mt-5">
      ...
      <div className="flex gap-3">
        <a href="#" className="border-2 border-purple-500 p-3 rounded-full text-purple-500 hover:bg-purple-500 hover:text-white transition">
          <FaFacebookF />
        </a>
        <a href="#" className="border-2 border-purple-500 p-3 rounded-full text-purple-500 hover:bg-purple-500 hover:text-white transition">
          <FaLinkedinIn />
